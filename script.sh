...
# For CCVID dataset
python -m torch.distributed.launch --nproc_per_node=1 --master_port 12345 main.py --dataset ccvid --cfg configs/c2dres50_ce_cal.yaml --gpu 0 #
python -m torch.distributed.launch --nproc_per_node=1 --master_port 12345 main.py --dataset casiab --cfg configs/c2dres50_ce_cal.yaml --gpu 0